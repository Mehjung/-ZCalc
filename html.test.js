...
(async () => {
  ...
  const testCasesWithCheckbox = [
    { params: ["00:00", "-100:00", "00:00", "181:06"], expected: "-100:00" },
    { params: ["00:00", "-47:03", "-222:57", "318:09"], expected: "-160:51" },
    { params: ["00:00", "00:00", "-100:00", "100:00"], expected: "-100:00" },
    { params: ["00:00", "00:00", "-200:00", "350:00"], expected: "-59:00" },
    { params: ["-100:00", "-100:00", "-200:00", "450:00"], expected: "-59:00" },
    { params: ["-209:00", "-100:00", "-200:00", "350:00"], expected: "-59:00" },
    { params: ["-209:00", "-100:00", "-200:00", "350:00"], expected: "-59:00" },
    { params: ["-209:00", "00:00", "-200:00", "350:00"], expected: "-59:00" },
    { params: ["-209:00", "-100:00", "-50:00", "50:00"], expected: "-50:00" },
  ];
